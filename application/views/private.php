...
<html lang="en">
  <head>
     ...
     <title>My Private Area, Homes</title>
  ...
  <body>
      <div class="container"> 
  <h1>WELCOME TO MY PRIVATE AREA</h1>
   
    <h1>Home</h1>
   <h2>Welcome <?php echo $username; ?>!</h2>
    <button><a href="<?php echo base_url().'index.php/private_controller/logout' ?>">Logout</a></button>
         ...
         <div class="container">
          <div class="row ">
              ...
              <div class="col-md-9 col-md-push-3 well">
                ...
                //  echo form_close(); ?>
          <form action="<?php echo base_url().'index.php/private_controller/input' ?>" method="post" accept-charset="utf-8" class="form-horizontal">
              <fieldset>
                 ...
                 <input type="submit" name="input" value="Submit" onclick="save()">
